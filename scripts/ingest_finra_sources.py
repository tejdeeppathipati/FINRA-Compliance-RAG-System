...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--embed",
        action="store_true",
        help="Generate OpenAI embeddings for chunks; requires OPENAI_API_KEY.",
    )
...
def run(args: argparse.Namespace) -> int:
    ...
    embedding_provider = embed_text if args.embed else None
    embedding_model = get_settings().embedding_model if args.embed else None
